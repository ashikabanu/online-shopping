...
<link
	href="http://maxcdn.bootstrapcdn.com/bootswatch/3.3.4/flatly/bootstrap.min.css"
	rel="stylesheet">
<link href="http://cdn.jsdelivr.net/flat-ui/2.2.2/css/flat-ui.min.css"
	rel="stylesheet">
<style>
html, body, .container {
	height: 100%;
...
<body class="vs-screen-bg">
					...
					<div class="row">
						...
						<div class="col-sm-10 col-md-9">
							<div class="login-form">
								...
								<a class="btn btn-primary btn-lg btn-block" href="home">Log
									in</a> <a class="login-link" href="http://www.jquery2dotnet.com/"
									target="_blank">Lost your password?</a>
							</div>
						</div>
					</div>
				</div>
	...
	<script
		src="http://cdn.jsdelivr.net/bootstrap/3.3.4/js/bootstrap.min.js"></script>
	<script>
