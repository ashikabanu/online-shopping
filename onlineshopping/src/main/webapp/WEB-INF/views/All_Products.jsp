					...
					<div class="panel panel-default text-center">
						...
						<div class="panel-body">
							<img height="220px" width="250px"
								src="<c:url value="/resources/img/${product.id}.jpg" />"
								alt="${product.name}" />
						</div>
							...
							<div class="row">
								<div>
									...
									<c:if test="${isAdmin=='true'}">
										<a href="secure_logout" class="btn btn-success"> Login as
											user to add to cart <i class="fa fa-cart-plus"
											aria-hidden="true"></i>
										</a>
									</c:if>
									<c:if test="${!isUserLoggedIn=='true' && !isAdmin =='true'}">
										<a href="Login" class="btn btn-success"> Login to add to
